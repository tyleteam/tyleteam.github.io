const store = observable({
	rows: [
		...
		},
		{
			...
			endpoint:
				'https://s3.ap-northeast-2.amazonaws.com/tyle.io.seoul/cards.exports/ld/ldz5d5ejp6xix0/tyle-ldz-1.png',
			status: '',
			type: 'image',
		},
		{
			...
			endpoint:
				'https://d1s0awd0642fry.cloudfront.net/web/libs/bootstrap.min.css',
			status: '',
			type: 'css',
		},
		{
		...
		{
			name: 'storyblocks',
			domain: 'https://d1yn1kh78jj1rr.cloudfront.net',
			endpoint:
				'https://d1yn1kh78jj1rr.cloudfront.net/image/preview/2O0VXeG/graphicstock-beautiful-tanned-girl-in-a-blue-dress-standing-on-a-rooftop-of-red-van-and-spreading-arms_H0qpoVDsbb_SB_PM.jpg',
			status: '',
			type: 'image',
		},
		{
		...
		},
		{
			...
			endpoint:
				'https://static-videos.pexels.com/videos/855018/pictures/preview-0.jpg',
			status: '',
			type: 'image',
		},
		{
			...
			endpoint:
				'https://cdn.pixabay.com/photo/2018/07/25/06/09/butterfly-3560752_150.jpg',
			status: '',
			type: 'image',
		},
		{
...
const Row = observer(
	class Row extends Component {
		...
		render() {
			const { name, domain, endpoint, status } = this.props.row;
			return (
				<tr>
					<td>{name}</td>
					<td>{domain}</td>
